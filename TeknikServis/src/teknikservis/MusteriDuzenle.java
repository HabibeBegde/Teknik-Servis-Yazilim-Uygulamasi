...
public class MusteriDuzenle extends javax.swing.JFrame {
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        // TODO add your handling code here:
        AnaForm.musteriDuzenle.setVisible(false);
        AnaForm.musteri.setVisible(true);
    ...
    public void DBdenBilgiDoldur(){
        try {
            ...
            if (sonuckumesi.next()) {
                ...
                jTextField3.setText(sonuckumesi.getString(3));
                jTextField4.setText(sonuckumesi.getString(6));
                jTextField5.setText(sonuckumesi.getString(5));
                jTextArea1.setText(sonuckumesi.getString(4));
    ...
    private void Kaydet() {
       try{
            String tc, ad, soyad, email, adres, telno;
            ...
            ifade=null;
            ifade=baglanti.createStatement();
            String str=("UPDATE müsteri SET  MüsteriAdi='"+ad+"', MüsteriSoyadi='"+soyad+"', Adres='"+adres+"', Email='"+email+"', TelNo='"+telno+"' where TCno='"+tc+"'"); 
            
            ifade.executeUpdate(str);
            String cikti="Güncelleme gerçekleştirildi.";
            JOptionPane.showMessageDialog(null, cikti);
        }
        catch (SQLException ex) {
            ex.printStackTrace();
